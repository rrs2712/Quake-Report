...
public final class QueryUtils {
    ...
    public static String inputStreamToString(InputStream inputStream) {
        ...
        try {
            ...
            Log.e("QueryUtils", e.getMessage(), e.getCause());
        }

        Log.d("RRS",output.toString());
        return output.toString();
    }

    public static List<Earthquake> getEarthquakesFromJson(String json) {
        Log.d("RRS", json);
        ...
        try {
            ...
            Log.e("getEarthquakesFromJson", e.getMessage());
            e.printStackTrace();
        }
...
//            } else {
//                Log.w("QueryUtils", "" + httpURLConnection.getResponseCode());
//            }
...
//            Get “properties” JSONObject
                JSONObject properties = feature.getJSONObject("properties"); //new JSONObject(feature.toString());
//            Extract “mag” for magnitude
                double mag = properties.getDouble("mag");
//            Extract “place” for location
                String place = properties.getString("place");
//            Extract “unixTime” for unixTime
                long time = properties.getLong("unixTime");
//            Extract “URL” for unixTime
                String url = properties.getString("url");
//            Create Earthquake java object from magnitude, location, and unixTime
